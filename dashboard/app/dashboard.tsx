...
export default function Dashboard() {
  ...
  return <main className="portal-shell">
    <header className="portal-header"><div className="brand"><div><span>MILESPAPA QUANT LAB · BACKTEST</span><h1>微型臺指期貨策略回測</h1></div></div><div className="headmeta"><em>● {loading?"回測中":"回測完成"}</em><span>{data.metadata.date_range}</span></div></header>

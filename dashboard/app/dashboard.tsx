...
type BacktestOptions = { available_start: string | null; available_end: string | null; max_days: number; strategies: { key: string; name: string }[]; intervals: { key: Timeframe; name: string }[] };

...
class CloudflareAccessValidator:
    ...
    Edge authentication alone can be bypassed by addressing the Lightsail IP
    directly. Origin validation keeps the Dashboard, REST API, and WebSocket
    closed unless Cloudflare signed the request for the configured audience.
    """
